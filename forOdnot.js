            ...
            <div class="gallery">
                <div class="img">
                    ...
                    <div class="caption">
                        <p>${array[i].title}</p>
                        <p>${array[i].price}</p>
                        <button class="order-btn" onclick="showOrderForm('Весна', '${array[i].scr}')">Заказать</button>
                    </div>
                </div>
                ...
                <div class="img">
                    ...
                    <div class="caption">
                        <p>${array[i+1].title}</p>
                        <p>${array[i+1].price}</p>
                        <button class="order-btn" onclick="showOrderForm('Весна', '${array[i+1].scr}')">Заказать</button>
                    </div>
                </div>
                ...
                <div class="img">
                    ...
                    <div class="caption">
                        <p>${array[i+2].title}</p>
                        <p>${array[i+2].price}</p>
                        <button class="order-btn" onclick="showOrderForm('Весна', '${array[i+2].scr}')">Заказать</button>
                    </div>
                </div>
